...
2. 再读 `research/pricing/inverse_options_math_proof.md`（注意其中部分推导说明可作为讨论起点，不要盲信文字结论，优先以代码+测试为准）。
3. 运行：
```bash
...
./venv/bin/python validation_scripts/inverse_pnl_math_validation.py
```
