...
3. `strategies/market_making/naive.py`
4. `research/backtest/engine.py`
5. `research/pricing/inverse_options.py`
6. `research/volatility/historical.py`
7. `research/risk/var.py`
8. `research/risk/circuit_breaker.py`
9. `strategies/market_making/avellaneda_stoikov.py`
10. `strategies/market_making/integrated_strategy.py`
